...
export const badgeVariants = tv({
	...
	variants: {
		variant: {
			...
			Pending: "bg-yellow-200 text-yellow-700 dark:bg-yellow-500 dark:text-yellow-900",
			Verified: "bg-green-200 text-green-700 dark:bg-green-400 dark:text-green-900"
		}
	},
	defaultVariants: {
		variant: "default"
